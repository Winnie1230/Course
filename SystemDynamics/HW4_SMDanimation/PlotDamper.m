% plot damper
function PlotDamper(damp_x,damp_y,x_range,damp_equ)
    % ------------------------------
    % damp_x: the rightest x coordinate of damper
    % damp_y: the y coordinate of damper
    % damp_equ: when SMD system is on "equilibrium point", the rightest x coordinate of damper
    % (to calculate the mid-vertical line of damper)
    % damp_origin: origin x coordinate of damper
    % x_range: width of damper(depend on the total moving range of the solution of ode45)
    % y_range: height of damper
    % dlen: the length of right/left horizontal part(depend on the total moving range of the solution of ode45)
